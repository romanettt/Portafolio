...
CREATE TABLE DISPONIBLIDAD
  (
    ...
    MEDICO_ID_MD   INTEGER NOT NULL ,
    JORNADA_ID_JOR INTEGER NOT NULL ,
...
ALTER TABLE REG_PAGO_COM ADD CONSTRAINT REG_PAGO_COM_PK PRIMARY KEY ( ID_PG_C ) ;
...
ALTER TABLE AGENDA ADD CONSTRAINT AGENDA_MEDICO_FK FOREIGN KEY ( MEDICO_ID_MD ) REFERENCES MEDICO ( ID_MD ) ;
...
ALTER TABLE DISPONIBLIDAD ADD CONSTRAINT DISPONIBLIDAD_JORNADA_FK FOREIGN KEY ( JORNADA_ID_JOR ) REFERENCES JORNADA ( ID_JOR ) ;
...
ALTER TABLE REG_PAGO_COM ADD CONSTRAINT REG_PAGO_COM_MEDICO_FK FOREIGN KEY ( MEDICO_ID_MD ) REFERENCES MEDICO ( ID_MD ) ;
